  ...
  getViewport().innerHTML = `
    <div id="lockscreen">
      <div class="lock-core">
        ...
        <p class="lock-sub">SECURE ADMIN RUNTIME — AUTHENTICATION REQUIRED</p>
        <button id="btn-discord-login" class="discord-btn">
        ...
        <p class="lock-fine">Access is restricted to authorised users only.</p>
      </div>
    </div>`;
